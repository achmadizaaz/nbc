                        ...
                        <form action="{{ route('attribute.store') }}" method="POST">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="name" class="form-control" id="attribute_name" placeholder="Enter attribute name" required>
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        {{-- Edit button --}}
                                        <button type="button" class="btn btn-sm text-bg-warning edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $attribute->id }}" data-name="{{ $attribute->name }}">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        {{-- Delete button --}}
                                        <button type="button" class="btn btn-sm btn-danger delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{ $attribute->id }}" data-name="{{ $attribute->name }}">
